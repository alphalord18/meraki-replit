import {
  users, events, speakers, blogs, sponsors,
  type User, type Event, type Speaker, type Blog, type Sponsor,
  type InsertUser, type InsertEvent, type InsertSpeaker, type InsertBlog, type InsertSponsor
} from "@shared/schema";
